...
{
    [DbContext(typeof(Movie_Origination_System_DB))]
    partial class Movie_Origination_System_DBModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Movie_Origination_System.Business.Director_details", b =>
                {
            ...
            modelBuilder.Entity("Movie_Origination_System.Business.Movie_Origination_Table", b =>
                {
            ...
            modelBuilder.Entity("Movie_Origination_System.Business.Movie_details", b =>
                {
                    b.Property<int>("Movie_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Movie_Origination_System.Business.Producer_details", b =>
                {
                    b.Property<int>("Movie_Producer_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Movie_Origination_System.Business.Movie_Origination_Table", b =>
                {
                    b.HasOne("Movie_Origination_System.Business.Director_details", "Director_details")
                        .WithMany()
                        .HasForeignKey("Director_detailsMovie_Director_ID");

                    b.HasOne("Movie_Origination_System.Business.Movie_details", "Movie_details")
                        .WithMany()
                        .HasForeignKey("Movie_detailsMovie_ID");

                    b.HasOne("Movie_Origination_System.Business.Producer_details", "Producer_details")
                        .WithMany()
